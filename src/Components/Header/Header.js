...
<div class="navbar bg-neutral">
  <div class="navbar-start">
    <div class="dropdown">
      ...
      <ul tabindex="0" class="menu text-white menu-compact dropdown-content mt-3 p-2 shadow bg-neutral rounded-box w-52">
        <li><a >Item 1</a></li>
        <li tabindex="0">
    ...
    <a class="btn btn-ghost text-white normal-case text-xl">Note Manager</a>
  </div>
